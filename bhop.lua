...
button3.MouseButton1Click:Connect(function()
	...
	local selfcham = localPlayer.Character
...
button.MouseButton1Click:Connect(function()
	...
	local speedbefore = localPlayer.Character.Humanoid.WalkSpeed
	if _G.click == true then
		while _G.click == true do
			...
			elseif localPlayer.Character.Humanoid.WalkSpeed > 60 then
				wait(1)
			end
		end
	elseif _G.click == false then
		localPlayer.Character.Humanoid.WalkSpeed = speedbefore
	end
end)
